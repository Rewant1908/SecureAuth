  ...
  return (
      <div style={{ minHeight: "100vh", background: "#0b1326", color: "#dae2fd", fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{
          ...
          padding: "0 40px",
          background: "rgba(11,19,38,0.75)", backdropFilter: "blur(20px)",
        ...
        <div style={{ marginLeft: "240px", paddingTop: "56px", minHeight: "100vh" }}>
          {page === "simulator"
              ...
              : <DashboardPage
                  result={result}
                  mfaRequired={mfaRequired} mfaMethod={mfaMethod}
                  mfaCode={mfaCode} setMfaCode={setMfaCode}
                  mfaLoading={mfaLoading} mfaError={mfaError}
  ...
  return (
      <div style={{ padding: "56px 64px", maxWidth: "900px" }}>
        <div style={{ marginBottom: "48px" }}>
          <h1 style={{ fontFamily: "'Manrope',sans-serif", fontSize: "52px", fontWeight: 800, lineHeight: 1.1, marginBottom: "16px" }}>
            Simulate Access
          </h1>
...
function DashboardPage({ result, mfaRequired, mfaMethod, mfaCode, setMfaCode, mfaLoading, mfaError, onMfaVerify, session }) {
  ...
  const decisionDesc = result.status === "success"
      ...
      <div style={{ padding: "40px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "20px", marginBottom: "24px" }}>
                ...
                <div style={{ marginTop: "20px" }}>
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    ...
                    <button onClick={onMfaVerify} disabled={mfaLoading} style={{
                      ...
                      border: "none", borderRadius: "8px", color: "#001f2a",
                      fontWeight: 700, fontSize: "13px", cursor: mfaLoading ? "not-allowed" : "pointer"
                    }}>
                      {mfaLoading ? "..." : "Verify"}
                    </button>
                  </div>
          ...
          <div style={{ background: "#171f33", borderRadius: "24px", padding: "36px", boxShadow: "12px 24px 48px rgba(218,226,253,0.06)" }}>
            ...
            <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: "40px", fontWeight: 800, color: ringColor }}>
              {level === "HIGH" ? "Critical" : level === "MEDIUM" ? "Elevated" : "Normal"}
            </span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "24px" }}>
          ...
          <div style={{ background: "#171f33", borderRadius: "24px", padding: "32px", boxShadow: "12px 24px 48px rgba(218,226,253,0.06)" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "28px" }}>
              ...
              <span style={{ background: "rgba(76,214,255,0.1)", border: "1px solid rgba(76,214,255,0.25)", color: "#4cd6ff", padding: "3px 10px", borderRadius: "4px", fontSize: "11px", fontFamily: "'JetBrains Mono',monospace" }}>
        ...
        <div style={{ background: "#131b2e", borderRadius: "24px", padding: "32px", boxShadow: "12px 24px 48px rgba(218,226,253,0.06)" }}>
          ...
          <pre style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "13px", lineHeight: 1.8, color: "#8a97b8", overflow: "auto", background: "#0b1326", borderRadius: "12px", padding: "24px" }}>
